...
<div id="page-wrapper">
  ...
  <div id="page" class="<?php print $theme_layout;?>
  <?php print $frame;?>">
          ...
          <div id="columns">
            <div class="columns-inner clearfix">
              ...
              <?php if ($page['sidebar_first']):?>
                <div id="sidebar-first" class="sidebar-first <?php print
          $sidebar_first_grid . ' ' . $sidebar_first_pull;?>">
                  <?php print render($page['sidebar_first']); ?>
                </div>
              <?php endif;?>
              <?php if ($page['sidebar_second']):?>
              <div id="sidebar-second" class="sidebar-second <?php print
          $sidebar_second_grid . ' ' . $sidebar_second_pull;?>">
